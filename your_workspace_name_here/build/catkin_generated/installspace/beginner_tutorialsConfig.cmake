...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/pi/your_workspace_name_here/src)
  set(beginner_tutorials_DEVEL_PREFIX /home/pi/your_workspace_name_here/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/pi/your_workspace_name_here/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'test <test@test.nl>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/your_workspace_name_here/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/your_workspace_name_here/install/lib;/opt/ros/kinetic/lib)
